...
Evaluates an AI model's ability to correctly answer everyday questions that rely on basic
commonsense knowledge and understanding of the world.

## At a glance

| | |
|---|---|
| Upstream | [`src/inspect_evals/commonsense_qa`](https://github.com/UKGovernmentBEIS/inspect_evals/tree/main/src/inspect_evals/commonsense_qa) |
| Group | Knowledge |
| Total samples | 1,221 |
...
| Task | Samples |
|---|---|
| `commonsense_qa` | 1,221 |

### External assets

- `huggingface` — `tau/commonsense_qa` (pinned)
