#!/usr/bin/env python3
"""Run ONE problem of commonsense_qa through TrustedRouter and emit a reproducibility bundle.
...
TASK = "inspect_evals/commonsense_qa"
...
def main() -> int:
    ap = argparse.ArgumentParser(description="Run one commonsense_qa problem via TrustedRouter")
